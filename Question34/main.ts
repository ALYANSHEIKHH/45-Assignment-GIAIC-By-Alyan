...
*/
 let favorite_pizza:string[]=['Peperoni' , 'Mexican' , 'Hawaiian'];
 for(let i=0; i<favorite_pizza.length;i++){
     console.log(`I like ${favorite_pizza[i]} pizza`)
 }

 for(let i=0; i<favorite_pizza.length;i++){
     console.log(`I really love ${favorite_pizza[i]} pizza`)

 }
 console.log("\n My favorite food is pizza because it is delicious, has many different toppings to choose from, and you can get it easily.I really love pizza!")
