...
let myName = `Alyan`;
console.log('Is myName == Alyan');
console.log(myName == `Alyan`);
let myBike = `Royal Enfield`;
console.log("Is myBike == `royal Enfield`?I predict its False.");
console.log(myBike == `royal enfield`);
let myCar = `Porsche`;
console.log(myCar == `Porsche`);
console.log(myCar == `Porsche`);
...
let myfavfruit = `Peach`;
console.log(myfavfruit == `Peach`);
console.log(myfavfruit == `Peach`);
let myfavFood = `Biryani`;
console.log(myfavFood == `Salad`);
console.log(myfavFood == `Pasta`);
let myfavAnimal = `CHeetah`;
console.log(myfavAnimal == `Cheetah`);
console.log(myfavAnimal === `Cheetah`);
let myLaptop = `Fujitsu`;
console.log(myLaptop == `Fujitsu`);
console.log(myLaptop == `HP`);
