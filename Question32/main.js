...
let current_users = [`Alyan Sheikh`, `Andrew Tate`, `Daniyal Khan`, `David Goggins`, `Vladmir Hitler`];
let new_users = [`TOP G`, `Isfhan`, `Abu Obaida`, `Osama Bin Laden`, `Lewis Hamilton`];
