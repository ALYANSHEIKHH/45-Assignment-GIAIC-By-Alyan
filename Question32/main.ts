/* Question32: Checking Usernames: Do the following to create a program that simulates how websites ensure
...
• Loop through the new_users list to see if each new username has already been used. If it has, print
 a message that the person will need
...
let current_users: string[] = [`Alyan Sheikh` , `Andrew Tate` , `Daniyal Khan` , `David Goggins` , `Vladmir Hitler`]
let new_users: string[] = [`TOP G` , `Isfhan` , `Abu Obaida` , `Osama Bin Laden` , `Lewis Hamilton`]
